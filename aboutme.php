...
<div class="about-container">
    <div class="about-card">
        <div class="about-header">
            <h1>Tentang Kami</h1>
            <p class="tagline">Koleksi Fashion Muslim dengan Kualitas Terbaik</p>
        </div>
        ...
        <div class="about-content">
            ...
            <div class="about-section">
                ...
                <ul class="about-list">
                    <li>Produk Kami Original dengan Harga Kompetitif</li>
                    <li>Kualitas dan Bahan Terjamin</li>
                    <li>Pelayanan Customer Service Terbaik</li>
                </ul>
            </div>

            <div class="about-footer">
                <p>Terima kasih telah mengunjungi Inda Gallery. Kami berharap dapat melayani Anda dengan sebaik mungkin!</p>
            </div>
        </div>
    </div>
</div>
